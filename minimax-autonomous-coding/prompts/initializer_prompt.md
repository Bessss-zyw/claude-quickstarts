...
Start by reading `app_spec.txt` in your working directory using the `read_file` tool.
...
- Cover every major feature in the spec exhaustively
...
If you have time remaining in this session, begin implementing the highest-priority
